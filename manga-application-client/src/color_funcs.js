...
export function applyColors() {
    ...
    if (lightTheme()) {
      ...
      accentColorActive =          HSVtoHEX(h, 0.30, 1.0)
      ...
      bgColor =                    HSVtoHEX(h, 0.04, 0.15)
      fgColor =                    HSVtoHEX(h, 0.04, 0.11)
    ...
    document.documentElement.style.setProperty('--inactive-font-color-active',   inactiveFontColorActive)
    ...
    document.documentElement.style.setProperty('--inactive-accent-color-hover',  innactiveAccentColorHover)
    document.documentElement.style.setProperty('--inactive-accent-color-active', innactiveAccentColorActive)
